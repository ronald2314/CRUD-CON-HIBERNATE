...
public class Main {
	...
	static final StandardServiceRegistry registry = new StandardServiceRegistryBuilder()
		...
		public static void  main(String[] args) {
			...
			Curso cur2 = new Curso("FUNDAMENTOS DE ANDROID");
			...
			//INGRESAR ESTUDIANTE
			Estudiante est1 = new Estudiante("Ronald", "Rosado");
			Estudiante est2 = new Estudiante("Pepe", "Chalen");
			Estudiante est3 = new Estudiante("Julio","Cedeño");	
			...
			modificarEstudiante(6, "Maria", "Baque");
			...
			List<Estudiante> estudiantes = getEstudiantesPorNombre("Ronald");
